...
<body class="d-flex flex-column h-100">
    ...
    <div class="container" role="main">
        ...
        <p>We will be using the website to make full announcements throughout the whole process, but feel free to contact elections@mnfurs.org if you have any questions about things such as running for the board, how to vote in elections, or what is expected as a board member.</p>
    </div>
